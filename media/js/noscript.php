...
foreach($playersList as $manufacture=>$players) { echo '<h4>'.$manufacture.'</h4>'; echo '<p style="margin: 0 0 10px">';
echo '<strong>'.implode('</strong>, <strong>',$players).'</strong></p>'; } echo "</div>\r\n"; ?>