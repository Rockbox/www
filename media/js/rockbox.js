...
// DO NOT EDIT BELOW
window.addEvent("load",function(){if($("players_list")){new rockboxPlayersList()}$("svn_container").slide("hide").setStyle("height","auto");
$("svn_slider").setStyle("height","auto");$("svn_slider_handle").addEvent("click",function(a){a.preventDefault();
$("svn_container").slide()});new noobSlide({box:$("announcements_slider"),items:$$("#announcements_slider div"),size:380,handles:$$("#slider_handle span"),fxOptions:{duration:350},onWalk:function(a,b){this.handles.removeClass("selected");
b.addClass("selected")}})});